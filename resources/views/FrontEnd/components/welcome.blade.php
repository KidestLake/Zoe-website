                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="welcome-text">
                            <h2 data-animation="fadeInUp" data-delay="100ms">Download Zoe Now</h2>
                            <h5 data-animation="fadeInUp" data-delay="300ms">Have the experience of Downloading and Listening to the best Christian Songs on your Phone.</h5>
                            <div class="welcome-btn-group">
                                <a href="#" class="btn poca-btn m-2 ml-0 active" data-animation="fadeInUp" data-delay="500ms">Download Zoe from Google play</a>
